...
- **提出**:2026-07-08
- **类型**:改进(安全 / 架构)
- **依赖**:[`../../archive/skill-system/design.md`](../../archive/skill-system/design.md)（Skill 与 `[skills]/` 虚拟路径已落地；历史设计仅解释前置）
...
进② design 细化方案（`/effort design`）。**前置已经满足**：Skill 系统和虚拟通道已经落地。design 要决定：
