# Plan 02：Project Session 与逐 Turn Invocation Context
...
- ProjectSessionContext：projectId、projectRoot、Project Flow catalog/default ref；
...
- WorkRun switch command（Plan 05 再由 `Work.switch` 暴露）原子提交当前 run deferred +
...
- 本阶段按 capability contract 模拟“有/无 Work runtime 能力”；Plan 05 接入真实工具
...
[Acceptance 02](acceptance-02-invocation-context.md) 全部通过并生成 `result-02.md`。
