# Acceptance 04：Project 内部 Worktree 执行

对应 [Plan 04](plan-04-worktree-execution.md)。
...
运行 typecheck、build:lib、unit、Git integration tests、check:links。`result-04.md` 包含三种
