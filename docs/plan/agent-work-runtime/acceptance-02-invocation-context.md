# Acceptance 02：Project Session 与逐 Turn Invocation Context

对应 [Plan 02](plan-02-invocation-context.md)。
...
运行 typecheck、build:lib、unit、相关 runtime E2E、check:links。`result-02.md` 必须包含
