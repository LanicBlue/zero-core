// TypeScript/JavaScript 代码大纲提取器
//
// # 文件说明书
//
// ## 核心功能
// 从 TypeScript/JavaScript 源码中提取 import、class、function、interface 等大纲节点
//
// ## 输入
// TypeScript/JavaScript 源代码文本
//
// ## 输出
// OutlineNode 数组（类、函数、接口、类型别名等）
//
// ## 定位
...
//
// ## 维护规则
// TS 语法变更（如 satisfies 关键字）需更新正则表达式
//
